...
<section class="home-section">
    ...
    <form method="post" enctype="multipart/form-data">
        <h1>เพิ่มการบริการ</h1>
        <div>
            <label>ชื่อการบริการ</label>
            <input type="text" name="servicename" placeholder="ชื่อการบริการ" required>
        </div>
        <div>
            <label>รูปภาพการบริการ</label>
    ...
    if(isset($_POST["submit"])){
        ...
        $serviceimg = $_FILES["fileToUpload"]["name"];
        $idadmin = $row['admin_ID'];
        $target_file = '../imageupload/service/' . basename($serviceimg);
        $sql = "INSERT INTO service (service_name,service_image,admin_ID) VALUES ('$name','$serviceimg','$idadmin')";
        ...
        if($query){
            ...
            $_SESSION["success"] = "เพิ่มข้อมูลผิดพลาด";
        }
    }
    ?>
