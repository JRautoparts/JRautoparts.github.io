...
<section class="home-section">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div>
            รายละเอียด :
            <input type="text" name="promotiondetails">
        </div>
        <div>
            รูปภาพ :
    ...
    if(isset($_POST["submit"])){
        ...
        $promotionimg = $_FILES["fileToUpload"]["name"];
        $idadmin = $row['admin_ID'];
        // print_r($_POST);
        $target_file = '../imageupload/promotion/' . basename($promotionimg);
        $sql = "INSERT INTO promotion (promotion_name,promotion_details,promotion_image,admin_ID) VALUES ('$name','$details','$promotionimg','$idadmin')";
