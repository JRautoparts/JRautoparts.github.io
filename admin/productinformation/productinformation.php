...
$sql = "SELECT * FROM product JOIN product_type ON product.product_type_ID = product_type.product_type_ID";
...
<section class="home-section">
    ...
    <H1 style="color:green"><?php if (isset($_SESSION["success"])) {
        ...
        ?></H1>
    <div>
        <button onclick="window.location.href='./addproduct.php'">เพิ่มข้อมูล</button>
        <br><br>
        <table id="datatable" class="display" style="width:70%">
            ...
            <?php while ($row = mysqli_fetch_array($result)) : ?>
                <tr>
                    ...
                    <th><?php echo $row["product_type_name"] ?></th>
                    <th><img src="../imageupload/product/<?php echo $row['product_image']; ?>" width="120px" height="100px"></th>
                    <th><?php echo $row["product_price"] ?></th>
                    <th><a href="./deleteproduct.php?ID=<?php echo $row["product_ID"] ?>">ลบ</a></th>
                    <th><a href="./editproduct.php?ID=<?php echo $row["product_ID"] ?>">แก้ไข</a></th>
                    <th><a>print</a></th>
                </tr>
            <?php endwhile; ?>
            </tbody>
