...
if(!isset($_SESSION["username"])){
    ...
    $query = "SELECT * FROM customer WHERE CONCAT(customer_name,customer_tel, carlicense_num) LIKE '%".$valueToSearch."%'";
...
<section class="home-section">
    ...
    <div>
        ...
        <button onclick="window.location.href='./addinformation.php'">เพิ่มข้อมูล</button>
        <table  id="datatable" class="display" style="width:70%">
            ...
            <?php while($row = mysqli_fetch_array($search_result)):?>
                <tr>
                    ...
                    <th><?php echo $row["customer_tel"]?></th>
                    <th><?php echo $row["carlicense_num"]?></th>
                    <th><a href="./deleteuser.php?ID=<?php echo $row["customer_ID"]?>">ลบ</a></th>
                    <th><a href="./edituser.php?ID=<?php echo $row["customer_ID"]?>">แก้ไข</a></th>
                </tr>
            <?php endwhile;?>
            </tbody>
