...
<section class="home-section">
    ...
    <H1 style="color:green"><?php if (isset($_SESSION["success"])) {
        ...
        ?></H1>
    <div>
        <button onclick="window.location.href='./addnews.php'">เพิ่มข้อมูล</button>
        <br><br>
        <table id="datatable" class="display" style="width:70%">
            ...
            <tbody><?php while ($row = mysqli_fetch_array($result)) : ?>
                <tr>
                    ...
                    <th><?php echo $row["news_name"] ?></th>
                    <th><?php echo $row["news_details"] ?></th>
                    <th><img src="../imageupload/news/<?php echo $row['news_image']; ?>" width="120px" height="100px"></th>
                    <th><a href="./deletenews.php?ID=<?php echo $row["news_ID"] ?>">ลบ</a></th>
                    <th><a href="./editnews.php?ID=<?php echo $row["news_ID"] ?>">แก้ไข</a></th>
                </tr>
            <?php endwhile; ?>
            </tbody>
        </table>
